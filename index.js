...
mongoose.connect("mongodb+srv://a2databaseararipeatmospheric:a2databaseararipeatmospheric@a2database.ctnjcnk.mongodb.net/?retryWrites=true&w=majority").then(() => {
